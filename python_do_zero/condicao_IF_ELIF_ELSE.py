 # Condição IF permite verifica condições e mudar o comportamento do programa.
...
if imc < 18.5:
    ...
    print(f'O sei IMC é {imc} considerado Normal')
elif imc >= 25 and imc <= 29.9:
    print(f'O sei IMC é {imc} considerado Sobrepeso')
elif imc >= 30 and imc <= 39.9:
    print(f'O sei IMC é {imc} considerado Obesidade')
elif imc >= 40.0:
